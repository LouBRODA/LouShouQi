...
final class ModelTests: XCTestCase {
    ...
    func testGetMovesV1() {
        ...
        let expectedValidMoves = [Model.Move(owner: .player1, rowOrigin: 0, columnOrigin: 1, rowDestination: 1, columnDestination: 1), Model.Move(owner: .player1, rowOrigin: 0, columnOrigin: 1, rowDestination: 0, columnDestination: 0), Model.Move(owner: .player1, rowOrigin: 0, columnOrigin: 3, rowDestination: 1, columnDestination: 3), Model.Move(owner: .player1, rowOrigin: 0, columnOrigin: 3, rowDestination: 0, columnDestination: 4), Model.Move(owner: .player1, rowOrigin: 1, columnOrigin: 0, rowDestination: 0, columnDestination: 0), Model.Move(owner: .player1, rowOrigin: 1, columnOrigin: 0, rowDestination: 2, columnDestination: 0), Model.Move(owner: .player1, rowOrigin: 1, columnOrigin: 0, rowDestination: 1, columnDestination: 1), Model.Move(owner: .player1, rowOrigin: 1, columnOrigin: 2, rowDestination: 2, columnDestination: 2), Model.Move(owner: .player1, rowOrigin: 1, columnOrigin: 2, rowDestination: 1, columnDestination: 1), Model.Move(owner: .player1, rowOrigin: 1, columnOrigin: 2, rowDestination: 1, columnDestination: 3), Model.Move(owner: .player1, rowOrigin: 1, columnOrigin: 4, rowDestination: 0, columnDestination: 4), Model.Move(owner: .player1, rowOrigin: 1, columnOrigin: 4, rowDestination: 2, columnDestination: 4), Model.Move(owner: .player1, rowOrigin: 1, columnOrigin: 4, rowDestination: 1, columnDestination: 3)]
